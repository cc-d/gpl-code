        ...
        setupLightboxHtml: function() {
            ...
            if (!this.$el) {
                ...
                if (this.items.length > 1) {
                    ...
                    $(
                        '<div class="slbArrows">' +
                            '<button type="button" title="' + o.prevBtnCaption + '" class="prev slbArrow sbtn' + o.prevBtnClass + '">' + o.prevBtnCaption + '</button>' +
                            '<button type="button" title="' + o.nextBtnCaption + '" class="next slbArrow sbtn' + o.nextBtnClass + '">' + o.nextBtnCaption + '</button>' +
                        '</div>'
            ...
            if (!this.lightboxEventsSetuped) {
                ...
                this.$el.on('click' + this.ens, function(e) {
                    ...
                    if ($target.is('.slbCloseBtn') || (self.options.closeOnOverlayClick && $target.is('.slbWrap'))) {
                        ...
                        var imageDim = document.getElementsByClassName('slbImage');
